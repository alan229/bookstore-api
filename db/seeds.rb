...
author1 = Author.create(name: "James Jackson", biography: "Hi, This is James Jackson")
author2 = Author.create(name: "Roberta Rock", biography: "Hi, This is Roberta Rock")
author3 = Author.create(name: "Daniel Duck", biography: "Hi, This is Daniel Duck")
author4 = Author.create(name: "Amanda Djidjinski", biography: "Hi, This is Amanda")
author5 = Author.create(name: "Zoe Zack", biography: "hi, This is Zoe")
author6 = Author.create(name: "Bill Burray", biography: "Hi, This is Bill Burray")
author7 = Author.create(name: "Charlie Chuck", biography: "Hi, This is Charlie")
...
bookf = Book.create(title: "Anyway", author: author6, publisher: pub3, price: 19.99)=end
